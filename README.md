...
-   Create a program in the `data-raw/` folder, named `<name>.R`, where `<name>` should follow the [naming convention](#naming-conventions), to generate the test data and output `<name>.rda` to the `data/` folder.
