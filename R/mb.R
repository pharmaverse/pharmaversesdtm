...
#'     \item{MBSTRESC}{Character Result/Finding in Standard Format}
#'     \item{MBSTRESN}{undocumented field}
#'     \item{MBSTRESU}{undocumented field}
#'     \item{MBSPEC}{Specimen Type}
#'     \item{MBLOC}{Specimen Collection Location}
#'     \item{MBMETHOD}{Method of Test or Examination}
#'     \item{VISITNUM}{Visit Number}
#'     \item{MBDTC}{Date/Time of Specimen Collection}
#'   }
#'
#' @source [Access the source of the Microbiology Findings dataset.](https://github.com/pharmaverse/pharmaversesdtm/blob/main/data/mb.rda)
