...
#'   }
#'
#' @source <a href="Constructed by {admiralvaccine} developers" target="_blank">Access the source of the Supplemental Qualifiers for Clinical Events for Vaccine dataset.</a>
"suppce_vaccine"
